...
namespace StockAnalyzerProject2
{
    ...
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            ...
            // Add the instances of the derived pattern recognizers to the ComboBox in the form
        ...
        // DisplayCandlestickChart() method generates the candlestick chart based on the provided data,
...

        {
            ...
            chart1.ChartAreas[0].AxisX.Title = "Date";
            chart1.ChartAreas[0].AxisX.TitleFont = new Font("Arial", 16, FontStyle.Regular);
            chart1.ChartAreas[0].AxisY.Title = "Price";
            chart1.ChartAreas[0].AxisY.TitleFont = new Font("Arial", 16, FontStyle.Regular);
